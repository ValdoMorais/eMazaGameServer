                    ...
                    <div class="pricing-inner section-inner">
                                ...
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"><span class="pricing-table-price-currency h2"></span><span class="pricing-table-price-amount h1">Gratuito</span><span class="text-xs">/mes</span></div>
                                        </div>
                        ...
                        <div class="pricing-table">
                            <div class="pricing-table-inner is-revealing">
                                <div class="pricing-table-main">
                                    <div class="pricing-table-header pb-24">
                                        <div class="pricing-table-price"><span class="pricing-table-price-currency h2">MT</span><span class="pricing-table-price-amount h1">141</span><span class="text-xs">/mes</span></div>
                                    </div>
                                    <div class="pricing-table-features-title text-xs pt-24 pb-24">What you will get</div>
                                    <ul class="pricing-table-features list-reset text-xs">
                                        <li>
            ...
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <ul class="footer-social-links list-reset">
                        ...
                        <li>
                            <a href="https://www.google.co.mz/"target=".blank">
                    ...
                    <div class="footer-copyright">&copy; 2022 Solid, todos direitos reservados</div>
                </div>
            </div>
        </footer>
    </div>
